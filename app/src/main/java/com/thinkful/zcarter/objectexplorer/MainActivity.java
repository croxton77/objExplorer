...
abstract class Baseball extends Ball {
    ...
    Baseball(int speed, String direction)
    {
        this.speed = speed;
    ...
    public void Throw(int speed, String direction) {
        Screen.log("a ball is thrown " +speed + "mph " + direction);
    }
}
...
class CurveBall extends Baseball{
    ...
    public void Throw(int speed, String direction){
        ...
        Screen.log("...and it has a curve of "+ curve);
    }
}
...
class Hardball extends Baseball {
    ...
    @Override
    public void pitch() {
        Screen.log("A hardball is pitched overhand at " +this.speed + "mph" );
        this.setChanged();
        this.notifyObservers();
    }
...
class BouncyBall {
    ...
    public void bounce() {
        Screen.log("The bouncy ball object bounces");
    }
}
...
class SuperBall extends BouncyBall{
    @Override
    public void bounce(){
        Screen.log("the super ball object bounces really high");
    }
...
public class MainActivity extends Activity {
    ...
    public void playBall() {
        ...
        CurveBall striker = new CurveBall(7);
        striker.Throw(7,"left");
